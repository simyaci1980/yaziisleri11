...
{//307
  ...
  {//396
  metin: "   93. <br> I. Bir hakkın açıkça kötüye kullanılmasını hukuk düzeni korur.<br> II.	Kanunda uygulanabilir bir hüküm yoksa hâkim, örf ve âdet hukukuna göre, bu da yoksa kendisi kanun koyucu olsaydı nasıl bir kural koyacak idiyse ona göre karar verir. <br> III.	Kanunun iyi niyete hukukî bir sonuç bağladığı durumlarda, asıl olan iyi niyetin varlığıdır ancak durumun gereklerine göre kendisinden beklenen özeni göstermeyen kimse iyi niyet iddiasında bulunamaz. 4721 sayılı Türk Medeni Kanunu'na göre başlangıç hükümleri ile ilgili verilenler doğru yanlış olarak değerlendirildiğinde sıralama hangisidir?	I.	II.	III.",
...
function cevapla() {
  ...
  if (secilenCevap) {
    ...
    dogruCevapElement.innerHTML ="<br> ===>   " + "  " + dogruCevap;
